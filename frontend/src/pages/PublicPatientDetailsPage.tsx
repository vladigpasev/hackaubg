...
import { PatientCard } from '../features/receptionist/components/PatientCard'
...
export function PublicPatientDetailsPage() {
  ...
  const summaryPatient = toPatientSummary(patient)
  ...
  return (
    ...
    >
      <section className="space-y-5">
        ...
        <PatientCard patient={summaryPatient} showPatientId={false} />

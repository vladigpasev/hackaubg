          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0 max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--text-secondary)] sm:text-lg">
                This page is a static example of the frontend direction: light surfaces, strong
                contrast, roomy cards, and obvious next actions. It demonstrates the visual
                language without adding product logic.
              </p>
            </div>
            ...
            <div className="flex w-full max-w-md flex-col gap-3 rounded-[1.75rem] border border-[var(--border-soft)] bg-[var(--surface-soft)] p-4 sm:p-5">
              ...
              <p className="text-sm leading-6 text-[var(--text-secondary)]">
                One primary action is visible first, urgent states are obvious, and supporting
                details stay quiet until needed.
              </p>
              ...
              <button className="min-h-12 rounded-[1.05rem] border border-[var(--border-soft)] bg-white px-4 text-sm font-semibold text-[var(--text-primary)] transition hover:bg-[var(--surface-secondary)]">
                Review UI guidance
              </button>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-[var(--border-soft)] bg-white p-5 shadow-[0_18px_50px_rgba(19,56,78,0.06)] sm:p-6">
            <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
              <div className="min-w-0">
                ...
                <h2 className="mt-2 text-2xl font-semibold break-words">Large buttons, one clear path at a time</h2>
              </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(300px,0.78fr)]">
          <div className="rounded-[2rem] border border-[var(--border-soft)] bg-white p-5 shadow-[0_18px_50px_rgba(19,56,78,0.06)] sm:p-6">
            <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
              <div className="min-w-0">
                ...
                <h2 className="mt-2 text-2xl font-semibold break-words">Readable records without a data wall</h2>
              </div>
              <p className="max-w-xl text-sm leading-6 text-[var(--text-secondary)] xl:max-w-sm">
              ...
              {caseCards.map((card) => (
                ...
                >
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <button className="min-h-14 w-full rounded-[1.1rem] border border-[var(--border-soft)] bg-white px-5 py-3 text-base font-semibold text-[var(--text-primary)] transition hover:bg-[var(--surface-secondary)] sm:w-auto">
                      {card.action}
                    </button>
                  </div>
                </article>
          ...
          <div className="flex flex-col gap-6">
            <section className="rounded-[2rem] border border-[var(--border-soft)] bg-white p-5 shadow-[0_18px_50px_rgba(19,56,78,0.06)] sm:p-6">
              ...
              <h2 className="mt-2 text-2xl font-semibold break-words">Consistent meaning, not decorative color</h2>
            ...
            <section className="rounded-[2rem] border border-[var(--border-soft)] bg-[linear-gradient(180deg,rgba(15,143,138,0.08),rgba(255,255,255,0.96))] p-5 shadow-[0_18px_50px_rgba(19,56,78,0.06)] sm:p-6">
              ...
              <h2 className="mt-2 text-2xl font-semibold break-words">Use this page as the visual starting point</h2>
              ...
              <button className="mt-5 min-h-14 w-full rounded-[1.2rem] border border-[var(--teal-strong)] bg-[var(--teal)] px-5 text-base font-semibold text-white shadow-[0_18px_40px_rgba(15,143,138,0.22)] transition hover:bg-[var(--teal-strong)]">
